...
const navItems: { href: string; icon: LucideIcon; label: string; section: string; roles: string[]; match?: string[] }[] = [
  ...
  { href: '/receivables', icon: Landmark, label: 'Finance', section: 'Finance', roles: MGMT, match: ['/receivables', '/month-end', '/staff-scorecard', '/outlet-comparison', '/peak-hours', '/trends', '/payroll', '/reports', '/audit'] },
