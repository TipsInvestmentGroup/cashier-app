...
export default function TipsDjBillsPage() {
  ...
  const [groupBy, setGroupBy] = useState<'none' | 'staff' | 'person'>('none')
    ...
    <AppShell>
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {([['none', 'Detailed'], ['staff', 'By Staff'], ['person', 'By Person']] as const).map(([k, label]) => (
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr className="text-left text-gray-600">
                    <th className="px-4 py-3 font-semibold">{groupBy === 'staff' ? 'Staff' : 'Person'}</th>
